...
if (isset($_POST['button_create'])) {
    ...
    // ini untuk menjalankan method getConnection yang berisi code membuka koneksi
...
<?php
                ...
                if ($stmt->execute()) {
                    ...
                    if ($stmtKaryawan->execute()) {
                        ...
                        $SESSION['hasil'] = false;
                        $SESSION['pesan'] = "Gagal simpan data";
                    }
                    } else {
                    $SESSION['hasil'] = false;
                    $SESSION['pesan'] = "Gagal simpan data";
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="post">
                ...
                <a href="?page=karyawanread" class="bth btn-danger btn-sm float-right ml-2">

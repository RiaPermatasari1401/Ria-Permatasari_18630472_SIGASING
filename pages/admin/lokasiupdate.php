                ...
                <div class="card-body">
                    <form method="post">
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" name="id" value="<?php echo $row['nama_lokasi'] ?>">
                            <input type"text" class="form-control" name="nama_lokasi" value="<?php echo $row['nama_lokasi'] ?>">
                        </div>
                        <a href="?page=lokasiread" class="bth btn-danger btn-sm float-right ml-2">
